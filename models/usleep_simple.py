...
import torch
import numpy as np
from models.usleep_parts_simple import *
...
class UNet(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=False):
        ...
        self.mid_linear = nn.Sequential(
            nn.Conv1d(80, 40, kernel_size = 1, stride = 1),
            nn.BatchNorm1d(40)
            )
        self.lstm = nn.LSTM(40,40,2,bidirectional=True,batch_first=True)
    ...
    def forward(self, x):
        ...
        x1 = self.inc(x)
        x2 = self.down1(nn.MaxPool1d(4,4)(x1))
        x3 = self.down2(nn.MaxPool1d(4,4)(x2))
        x4 = self.down3(nn.MaxPool1d(4,4)(x3))
        x5 = self.down4(nn.MaxPool1d(4,4)(x4))
        x6 = self.down5(nn.MaxPool1d(4,4)(x5))
        x7 = self.down6(nn.MaxPool1d(4,4)(x6))
